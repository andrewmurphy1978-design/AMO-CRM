...
export default function QuickAddInvoice({ projectId, lang }: { projectId: string; lang: Lang }) {
  ...
  return (
    <form ref={formRef} action={formAction} className="flex flex-wrap gap-2">
      ...
      <input name="number" placeholder={t.invoices.numberPlaceholder} className={`${FIELD_CLASS} w-40`} />
      <input
        name="amount"
        type="number"
        step="0.01"
